...
import { EmptyState, ReadOnlyNotice, SectionCard } from "../_components/club-ui";
    ...
    <div className="grid gap-8 xl:grid-cols-[1.1fr_0.9fr]">
      ...
      >
        {isAdmin ? (
          ...
          <ReadOnlyNotice>Guest mode is read-only. Admin sign-in is required to add, rename, archive, or reactivate members.</ReadOnlyNotice>
        )}
              ...
              >
                {isAdmin ? (
                  ...
                  <div className="flex flex-1 items-center justify-between gap-4">
                    ...
                    <span className="rounded-full border border-white/10 px-3 py-1.5 text-xs uppercase tracking-[0.2em] text-stone-400">
                      Active
                    </span>
                  </div>
                )}
